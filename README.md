### Olá, eu sou Pedro Henrique S Lima

- Atualmente estou trabalhando como Cientista de Dados em uma empresa de telecomunicações;

- Estou estudando, atualmente, sobre Engenharia de Dados buscando aperfeiçoar a minha prestação de serviço;

- Busco colaborar na solução de processos, aplicando automações que contribuem em tempo e mais produtividade;
